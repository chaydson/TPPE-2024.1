...
- Refatoração 3:   
  - Critério 1:  Ok 
  - Critério 2:  NOk  - Não foi passada uma referencia para a classe de origem,
    o produto, a classe ProductCreator continua com variáveis temporárias em
    seus métodos, o método createProduct não retorna o produto criado. (-60
    pontos)
  - Critério 3:  Ok 
